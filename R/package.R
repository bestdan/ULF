...
#'
#' @description This is a wrapper to \code{\link{require}} and \code{\link{install.packages}}.
...
#' @author Jason Bryer
#' @references http://jason.bryer.org/posts/2014-02-20/Loading_and_Installing_Packages.html
